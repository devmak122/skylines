...
const Home = () => (
  <div className="overflow-x-hidden">
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-evenly h-full px-4 py-8">
          <div className="text-white max-w-lg md:mb-0 text-center">
            <div className="text-xl md:text-xl font-light mobile:text-sm text-center  mb-4 font-poppins">
              <div className="">
                <Typewriter
                  text=" One of the most trusted companies in India"
                  typeSpeed={100}
                  startDelay={500}
                  cursorColor="white"
                />
    ...
    <div className="relative z-10 px-4 tablet:px-8 laptop:px-12 font-Montserrat">
      ...
      {/* Section Title */}
      <div className="flex justify-center mt-[-190px] items-center mobile:mt-10">
    ...
    <div className="relative">
      <div className="absolute inset-0">
        <div className="background-designs">
          ...
          <div className="h-[100px] w-[100px] border-b-[10px] border-l-[10px] border-orange-500 ml-[95px] mt-[180px] mobile:scale-75 mobile:ml-[10px] mobile:mt-[160px]"></div>
          <div className="h-[80px] w-[80px] bg-primary ml-[400px] mt-[-305px] mobile:ml-[280px] mobile:scale-75 mobile:mt-[-250px]"></div>
          <div className="h-[120px] w-[120px] border-t-[15px] border-r-[15px] border-primary ml-[925px] mt-[-10px]"></div>
          <div className="h-[300px] w-[300px] bg-primary bg-opacity-[10%] ml-[400px] mt-[130px] mobile:ml-[40px] mobile:mt-[100px]"></div>
          <div className="h-[80px] w-[80px] bg-primary bg-opacity-[10%] ml-[180px] mt-[-200px]"></div>

          <div className="h-[70px] w-[70px] rounded-full bg-primary bg-opacity-[5%] ml-[1430px] mt-[50px]"></div>
        </div>
        <div className="h-[300px] w-[300px] rounded-full bg-primary bg-opacity-[5%] mt-[-680px] ml-[1350px] mobile:ml-[350px] mobile:mt-[-550px]"></div>
        <div className="h-[300px] w-[300px] rounded-full bg-primary bg-opacity-[5%] mt-[350px] ml-[-190px]"></div>
        <div className="h-[60px] w-[60px] border-b-[10px] border-r-[10px] border-orange-500 ml-[1365px] mt-[-425px] mobile:scale-75 mobile:ml-[370px] mobile:mt-[-235px]"></div>


      </div>
      <div className="flex mt-[100px] justify-evenly relative z-10">
        <img className="h-[258px] w-[265px] mobile:ml-[10px] mobile:scale-75" src={client1} alt="" />
        <img className="mt-[130px] h-[393px] w-[471px] mobile:ml-[-250px] mobile:scale-75 mobile:mt-[220px]" src={client2} alt="" />
        <img className="mt-[230px] w-[320px] h-[248px] mobile:ml-[-330px] mobile:mt-[580px] mobile:scale-75" src={client3} alt="" />
      </div>
    </div>
